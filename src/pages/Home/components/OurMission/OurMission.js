    ...
    return (
        <div className='MissionContentBorder'>
                ...
                <div style={{ width: '85%', margin: '0 auto', y: fasterScroll }}>
                    ...
                    <p className={isVisible ? 'fade-in-top visible missionContent' : ' fade-in-top missionContent'} >Bolt provides an enriching platform that fosters collaboration, presents intellectually stimulating challenges, and facilitates hands-on experiences. This unique opportunity is open to students from diverse backgrounds, inviting them to immerse themselves in the dynamic realm of business technology.</p>
                </div>
